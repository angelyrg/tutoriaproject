<!-- Modal -->
<div class="modal fade" id="modal-eliminar-taller-<?php echo $taller['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="../app/talleres.destroy.php" method="post">
